...
public class SpriteComponent implements EntityComponent, IDrawable {
    ...
    private static final ShaderProgram sShaderProgram = new ShaderProgram("jlake/shaders/sprite.vsh", "jlake/shaders/sprite.fsh");
    ...
    public void draw(final RenderInfo renderInfo) {
        ...
        sShaderProgram.bind();
        sShaderProgram.setMat4(0, mMatrix);
        sShaderProgram.setMat4(1, renderInfo.camera().getViewProjection());
